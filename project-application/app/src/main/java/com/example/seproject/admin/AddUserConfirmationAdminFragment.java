...
public class AddUserConfirmationAdminFragment extends DialogFragment {
    ...
    public AddUserConfirmationAdminFragment() {
        super();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.add_user_confirmation_admin_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_yes).setOnClickListener(v -> {
            ...
            getParentFragmentManager().setFragmentResult(REQUEST_KEY_ADD_USER_CONFIRM, result);
            dismiss();
        });
    }
}
