...
public class RemoveUserConfirmationAdminFragment extends DialogFragment {
    ...
    public RemoveUserConfirmationAdminFragment() {
        super();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.remove_user_confirmation_admin_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_yes).setOnClickListener(v -> {
            ...
            getParentFragmentManager().setFragmentResult(REQUEST_KEY_REMOVE_USER_CONFIRM, result);
            dismiss();
        });
    }
}
